...
<head>
    ...
    <title>تعديل عرض الدفع - لوحة التحكم</title>
    ...
    <div class="max-w-2xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mt-4">تعديل عرض الدفع</h1>
                <p class="text-gray-600 mt-2">تحديث تفاصيل عرض الدفع</p>
            </div>

            <!-- Form -->
            <div class="bg-white shadow rounded-lg">
                <form action="{{ route('admin.custom-payment-offers.update', $customPaymentOffer->id) }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="customer_name"
                            name="customer_name"
                            value="{{ old('customer_name', $customPaymentOffer->customer_name) }}"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="customer_email"
                            name="customer_email"
                            value="{{ old('customer_email', $customPaymentOffer->customer_email) }}"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="customer_phone"
                            name="customer_phone"
                            value="{{ old('customer_phone', $customPaymentOffer->customer_phone) }}"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="amount"
                            name="amount"
                            value="{{ old('amount', $customPaymentOffer->amount) }}"
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            required
                        >{{ old('description', $customPaymentOffer->description) }}</textarea>
                        @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex gap-4 pt-6">
                        ...
                        <a 
                            href="{{ route('admin.custom-payment-offers.show', $customPaymentOffer->id) }}"
